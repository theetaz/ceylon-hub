...
export const CATALOG: Dataset[] = [
  {
    ...
    description: "9 provinces of Sri Lanka.",
    category: "admin",
    status: "ready",
  ...
  },
  {
    ...
    description: "25 administrative districts.",
    category: "admin",
    status: "ready",
  ...
  },
  {
    ...
    description: "District-level population and density.",
    category: "population",
    status: "pending",
    source: {
  ...
  },
  {
    ...
    description: "Age, gender, ethnicity, religion breakdown by district.",
    category: "population",
    status: "pending",
    source: {
      name: "Dept. of Census & Statistics",
  ...
  },
  {
    ...
    title: "Road network",
    shortTitle: "Roads",
    description: "Trunk, primary and secondary roads.",
    category: "infrastructure",
    status: "pending",
    source: { name: "OpenStreetMap", url: "https://www.openstreetmap.org/" },
    license: "ODbL",
